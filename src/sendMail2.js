...
const sendEmail = async (recipient) => {
    ...
    const subject = `🌟 Day 4 Highlights & Regular Classes Info 🌟  | Edufulness`;
    ...
    <div style="max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 5px; padding: 30px;">
        ...
        <main style="padding: 20px;">
            ...
            <h2 style="text-align: center; color: #0078d7;">🌟 Day 4 Highlights & Regular Classes Info 🌟</h2>

            <p>Hi ${name},</p>

            <p>We had an amazing <strong>Day 4</strong> of our <strong>Azure Data Engineering Training!</strong></p>
