...
const TwoSections = () => {
  ...
  return (
    <div className="flex h-screen">
      {/* Left Section */}
      <div
        className={`fixed top-0 left-0 z-20 h-full w-64 bg-gray-200 p-4 transition-transform duration-300 md:relative md:translate-x-0 ${
          isMenuOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <h2 className="text-lg font-bold mb-4">SQL Tutorials</h2>
      ...
      <button
        className="fixed top-4 left-4 z-30 block md:hidden p-2 bg-gray-200 rounded-full"
